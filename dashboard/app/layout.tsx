...
export default function RootLayout({
  ...
  const [windowState, setWindowState] = useState({open: false, resizing: false});
  ...
  useEffect(() => {
    const handleResize = (state:SetStateAction<{ open: boolean; resizing: boolean; }>) => setWindowState(state);
